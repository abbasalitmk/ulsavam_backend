...
class ChangePasswordSerializer(serializers.Serializer):
    """
    Change the authenticated user's password. If the account has no
    password yet (e.g. was only ever used via OTP login, or was just
    auto-generated by ensure_superadmin), current_password may be
    omitted.
    """
